...
import ShopAreaWrapper from './interactables/Shop/HatShopArea';
import TradingAreaWrapper from './interactables/Trading/HatTradingArea';
  ...
  return (
    <div id='app-container'>
      ...
      <div id='social-container'>
        <SocialSidebar controller={coveyTownController}/>
      </div>
    </div>
  );
}
